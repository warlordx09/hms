...
const AppBar = (props) => ( <
    ...
    background = 'brand'
    pad = {
        { left: 'medium', right: 'small', vertical: 'small' }
    }
    style = {
        { zIndex: '1' }
    } {...props }
...
export class CreateAccount extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            Form onReset = { event => console.log(event) }
            method = "post"
            onSubmit = {
                ({ value }) => {
            ...
            required / >
            <
            FormField label = "Medical History - Conditions"
            name = "conditions"
            placeholder = "Conditions" /
            >
            <
            FormField label = "Medical History - Surgeries"
            name = "surgeries"
            placeholder = "Surgeries" /
            >
            <
            FormField label = "Medical History - Medications"
            name = "medications"
            ...
            required validate = {
                { regexp: /^(?=.{8,})(?=.*[0-9]{2})/, message: "@ least 8 characters containing 2 digits" }
            }
            /> <
            Box direction = "row"
            align = "center" >
            ...
            Button primary label = "I'm a doctor"
            href = "/MakeDoc" / >
            <
            /Box> < /
            Form > <
